...
const GalleryCard = ({ category, title, image }: GalleryCardProps) => {
  return (
    <div className="basis-full sm:basis-[calc(50%-28px)] lg:basis-1/3 ">
      <div className="relative">
        ...
        <Link
          href=""
          className="group absolute z-50 max-w-[80%] sm:max-w-80.5 w-full bg-white px-[23px] py-[16px] rounded-[12px] left-1/2 -translate-x-1/2 -translate-y-1/2 flex justify-between items-end"
        >
